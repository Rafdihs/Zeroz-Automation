...
WebUI.click(findTestObject('Object Repository/Zeroz_Pages/Page_zeroz  Pages/a_page 1_on-default edit-row'))

WebUI.setText(findTestObject('Object Repository/Zeroz_Pages/Page_zeroz  Edit/input_Page title_title'), 'page 2')

WebUI.setText(findTestObject('Object Repository/Zeroz_Pages/Page_zeroz  Edit/input_Page slug_slug'), 'page2')

WebUI.click(findTestObject('Object Repository/Zeroz_Pages/Page_zeroz  Edit/button_Save Changes'))
