...
WebUI.click(findTestObject('Object Repository/Zeroz_Faqs/Page_zeroz  Faqs/a_Add New Faq'))

WebUI.setText(findTestObject('Object Repository/Zeroz_Faqs/Page_zeroz  Faqs/input_Title_title'), 'faqs new')

WebUI.setText(findTestObject('Object Repository/Zeroz_Faqs/Page_zeroz  Faqs/textarea_Details_details'), 'faqs is bla...')

WebUI.click(findTestObject('Object Repository/Zeroz_Faqs/Page_zeroz  Faqs/button_Save'))
